...
<div id="show"><img src="{tpl_path}images/common/loading.gif" style="vertical-align:middle;" /> 数据加载中,请稍等...</div>
</div>
...
var click_url = '<?php echo $query->click_url;?>';
var pid = '<?php echo $this->config->item('ali_pid');?>';
var wt = '0';
var ti = '625';
var tl = '230x45';
var rd = '1';
var ct = encodeURIComponent('itemid=<?php echo $query->num_iid;?>');
var st = '2';
