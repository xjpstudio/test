...
<div class="wrap">
  ...
  <div class="tab_block" style="height:350px">
    <form method="post" action="<?php echo my_site_url(CTL_FOLDER.'tb_login/add_user');?>">
      <table width="100%" border="0" cellspacing="0" cellpadding="5" style="margin-top:10px">
        <tr>
          <td colspan="2" align="center"><img src="{tpl_path}images/common/tips.jpg" style="vertical-align:middle" /> 第一次使用淘宝账号登录，必须完成以下操作才会登录成功。</td>
        </tr>
        <tr>
  ...
  <div class="tab_block" style="display:none;height:350px">
    <form method="post" action="<?php echo my_site_url(CTL_FOLDER.'tb_login/bind_user');?>">
      <table width="100%" border="0" cellspacing="0" cellpadding="5" style="margin-top:10px">
        <tr>
          <td colspan="2" align="center"><img src="{tpl_path}images/common/tips.jpg" style="vertical-align:middle" /> 第一次使用淘宝账号登录，必须完成以下操作才会登录成功。</td>
        </tr>
