...
<table width="100%" border="0" align="center" cellpadding="5" cellspacing="0" >
  <tr>
    ...
    <td width="97%" align="left" >您现在的位置： <a href="<?php echo site_url(CTL_FOLDER.'flash');?>">焦点图片</a> &gt; 图片修改</td>
  </tr>
</table>
<fieldset>
<legend>焦点图片修改</legend>
<form action="<?php echo site_url(CTL_FOLDER."flash/save_record");?>" method="post" enctype="multipart/form-data" name="dialog_edit_form" id="dialog_edit_form">
  <table width="100%"  border="0" cellpadding="3" cellspacing="0" >
    ...
    <tr>
      ...
      <td width="592"><input Name="hplink" value="<?php echo $edit_data['hplink'];?>" type="text" Id="hplink" size="50"></td>
    </tr>
    <tr>
      <td>上传图片：</td>
  ...
  <input type="button" name="sbmit" onclick="subForm(this.form,this)" value="修改" class="button-style2" /></td>
    </tr>
  </table>
</form>
</fieldset>
