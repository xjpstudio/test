...
<table width="100%" border="0" align="center" cellpadding="5" cellspacing="0" >
  <tr>
    ...
    <td width="97%" align="left" >您现在的位置：<a href="<?php echo $url;?>">采集规则列表</a> &gt; 添加采集规则</td>
  </tr>
</table>
<fieldset>
<legend>添加规则</legend>
<form action="<?php echo site_url(CTL_FOLDER."rule/save_copy_record");?>" method="post" name="dialog_edit_form" id="dialog_edit_form">
  <table width="100%"  border="0" cellpadding="3" cellspacing="0" >
    ...
    <tr>
      ...
      <br>简短，达到唯一性即可，不包含列表项在内，一般为包围列表项的开始标签。</td>
    </tr>
    <tr>
     ...
     <tr>
      ...
      <td width="561"><textarea dataType="Limit" max="500" min="1" msg="长度1-500" name="list_link_s" cols="50" rows="5"><?php echo $edit_data['list_link_s'];?></textarea>
       <br><b style="color:#009900">一般从”预抓取列表区内容“中取得</b>,简短，达到唯一性即可，不包含a标签在内，一般为包围a标签的开始标记。</td>
    </tr>
   <tr>
      ...
      <br> <b style="color:#009900">一般从”预抓取列表区内容“中取得</b>,简短，达到唯一性即可，不包含a标签在内，一般为包围a标签的结束标记。<br><input type="button" value="预抓取列表项" style="width:150px" onclick="get_list(this.form)" /></td>
    </tr>
     <tr>
      ...
      <td width="561"><textarea dataType="Limit" max="500" min="1" msg="长度1-500" name="detail_s" cols="50" rows="5"><?php echo $edit_data['detail_s'];?></textarea>
       <br>简短，达到唯一性即可，不包含正文部分，一般为包围正文的开始标记。</td>
    </tr>
    <tr>
      ...
      <br>简短，达到唯一性即可，不包含正文部分，一般为包围正文的结束标记。</td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td><input name="url" type="hidden" value="<?php echo $url;?>" />
