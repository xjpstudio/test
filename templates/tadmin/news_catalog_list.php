...
<table width="100%" border="0" align="center" cellpadding="5" cellspacing="0" >
  <tr>
    ...
    <td width="97%" align="left" >您现在的位置：<a href="<?php echo site_url(CTL_FOLDER."news");?>">文章列表</a> &gt; 分类管理</td>
  </tr>
</table>
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-bottom:solid 1px #3C4952; margin-bottom:5px; margin-top:5px">
  <tr>
    ...
    <td width="416" align="right"  style="padding-right:10px"><a href="<?php echo my_site_url(CTL_FOLDER.'news_catalog/re_cache');?>"><img src="{tpl_path}images/refresh.jpg"  /> 更新缓存</a> | <a href="<?php echo site_url(CTL_FOLDER."news");?>"><img src="{tpl_path}images/default_icon.gif" border="0"> 管理文章</a></td>
  </tr>
</table>
<form method="post" name="list_form" id="list_form">
  <table width="100%" cellspacing="0" class="widefat">
    <thead>
      <tr id="trth">
        ...
        <th width="62%" id="cat_name">标题</th>
        <th width="14%">是否首页显示</th>
        <th width="12%">排序</th>
        <th width="9%">操作</th>
      </tr>
    </thead>
  ...
  <?php }?></td>
        ...
        <td><a href="<?php echo site_url(CTL_FOLDER."news_catalog/edit_record/".$row->id);?>">修改</a></td>
      </tr>
      <?php }?>
    </tbody>
  </table>
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td style="padding-top:5px"><select name="action_url" id="action_url">
          ...
          <option value="<?php echo site_url(CTL_FOLDER."news_catalog/del_record");?>">删除</option>
          <option value="<?php echo site_url(CTL_FOLDER."news_catalog/sort_record");?>">排序</option>
        </select>
        &nbsp;
...
<div id="dialog_add" style="display:none; position:relative">
  <form action="<?php echo site_url(CTL_FOLDER."news_catalog/add_record");?>" method="post" name="dialog_add_form" id="dialog_add_form">
    <table width="100%"  border="0" cellpadding="3" cellspacing="0" >
      <tr>
        <td width="164"><font color="#FF0000">*</font>所属分类：</td>
        <td width="551"><select name="parent_id" id="parent_id">
            <option value="0">==根目录==</option>
            <?php foreach($catalog_list as $row) {?>
            <option value="<?php echo $row->id;?>"><?php echo str_repeat("&nbsp;&nbsp;&nbsp;&nbsp;",$row->deep_id).$row->cat_name;?></option>
            <?php }?>
          </select> &nbsp;&nbsp; <label style="color:#F00"><input type="checkbox" name="is_push" value="1" />首页显示</label></td>
      </tr>
      <tr>
        <td width="164"><font color="#FF0000">*</font>分类标题：</td>
        <td width="551"><input Name="cat_name" type="text" size="30" dataType="Require" msg="该项必须填写"></td>
      </tr>
      <tr>
          <td>网页标题：</td>
