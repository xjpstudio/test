...
<table width="100%" border="0" cellpadding="5" cellspacing="0" >
  <tr>
    ...
    <td width="97%" align="left" >您现在的位置：<a href="<?php echo site_url(CTL_FOLDER."news");?>">文章列表</a> &gt; 添加文章 </td>
  </tr>
</table>
<div id="TabAdd" style="display:none">
  ...
  <form  action="<?php echo site_url(CTL_FOLDER."news/add_record");?>" method="post" enctype="multipart/form-data" name="dialog_add_form" id="dialog_add_form">
    <div id="TabAdd-1">
      <table width="100%"  border="0" cellpadding="3" cellspacing="0" >
        ...
        <tr>
          ...
          <td width="592"><input Name="title" type="text" size="50" dataType="Require" msg="该项必须填写" maxlength="100"> </td>
        </tr>
        <tr>
          <td width="133">网页标题：</td>
          <td width="592"><input name="btitle" type="text" size="50" maxlength="100" value="{title}-{site_title}" /> 标签说明：网站标题{site_title}，文章标题{title}</td>
        </tr>
        <tr>
          <td width="133">meta关键词：</td>
          <td width="592"><input type="text" name="keyword" maxlength="100" size="50"  />
            <br>
        ...
        <tr>
          <td>摘要：</td>
          <td><textarea name="summary" id="summary" cols="50" rows="5"></textarea></td>
        </tr>
        <tr>
          <td width="133">作者：</td>
          <td width="592"><input Name="author" type="text" size="10" maxlength="50" value="admin">
          </td>
        </tr>
        <tr>
          <td width="133">来源：</td>
          <td width="592"><input Name="source" type="text" value="未知" size="10" maxlength="50">
          </td>
        </tr>
        <tr>
          <td width="133"><font color="#FF0000">* </font>发布日期：</td>
          <td><input name="create_date" onClick="WdatePicker({'dateFmt':'yyyy-MM-dd HH:mm:ss'})" type="text" readonly="readonly" size="40" value="<?php echo date("Y-m-d H:i:s");?>" >
          </td>
        </tr>
        <tr>
          <td>上传图片：</td>
          <td><input type="text" name="pic_path" id="pic_path" size="25" maxlength="255" />
            ...
            <input type="button" class="button-style2" onclick="GetFileDialog('pic_path')" value="选择文件" />
            <br>
            上传图片格式：<?php echo UP_IMAGES_EXT;?> </td>
        </tr>
        <tr>
    ...
    <div id="TabAdd-2">
      <textarea name="content" id="content" style="width:780px; height:450px;visibility:hidden;"></textarea>
    </div>
