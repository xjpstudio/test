...
<table width="100%" border="0" cellpadding="0" cellspacing="0"  style="border-bottom:solid 1px #3C4952; margin-bottom:5px; margin-top:5px">
        <tr>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td style="padding-top:5px"><select name="action_url" id="action_url" onchange="to_catalog_onChange()">
          ...
          <option value="<?php echo site_url(CTL_FOLDER."file_manage/pack_download");?>">打包下载</option>
      ...
      <input name="submit_list_button" type="button" class="button-style2" id="submit_list_button" onclick="submit_list_form(this.form,this)" value="执行操作" />  <img src="{tpl_path}images/notice.gif"  title="操作步骤：在左边勾选要操作的记录-->选择需要执行的操作-->点击“执行操作”按钮-->完成" /></td>
    </tr>
  </table>
</form>
