...
<table width="100%" border="0" align="center" cellpadding="5" cellspacing="0" >
  <tr>
    ...
    <td width="97%" align="left" >您现在的位置：<a href="<?php echo $url;?>">文章列表</a> &gt; 文章修改</td>
  </tr>
</table>
<div id="TabAdd" style="display:none">
  ...
  <form action="<?php echo site_url(CTL_FOLDER."news/save_record");?>" method="post" enctype="multipart/form-data" name="dialog_edit_form" id="dialog_edit_form">
    <div id="TabAdd-1">
      <table width="100%"  border="0" cellpadding="3" cellspacing="0" >
        ...
        <tr>
          <td>摘要：</td>
          <td><textarea name="summary" cols="50" rows="5"><?php echo $edit_data['summary'] ;?></textarea></td>
        </tr>
        <tr>
          <td width="133">作者：</td>
        ...
        <tr>
          ...
          <td><input name="create_date" readonly="readonly" onClick="WdatePicker({'dateFmt':'yyyy-MM-dd HH:mm:ss'})" type="text" value="<?php echo date("Y-m-d H:i:s",$edit_data['create_date']);?>" size="40" />
          </td>
        </tr>
        <tr>
          <td>上传图片：</td>
