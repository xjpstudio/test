...
<script type="text/javascript" src="{root_path}js/jquery/jquery.pstrength-min.1.2.js"></script>
...
<div id="dialog_add" style="display:none; position:relative">
  <form action="<?php echo site_url(CTL_FOLDER."admin/add_record");?>" method="post" name="dialog_add_form" id="dialog_add_form">
    <table width="100%"  border="0" cellpadding="3" cellspacing="0" >
      ...
      <tr>
        <td><font style="color:#FF0000">*</font>管理员邮箱：</td>
        <td><input type="text" name="email" dataType="Email" style="width:150px" msg="邮箱格式有误" title="很重要，作为找回密码的接收邮箱，必须有效" /></td>
      </tr>
    </table>
  </form>
</div>
