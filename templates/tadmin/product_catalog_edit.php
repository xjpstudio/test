...
<table width="100%" border="0" align="center" cellpadding="5" cellspacing="0" >
  <tr>
    ...
    <td width="97%" align="left" >您现在的位置：<a href="<?php echo site_url(CTL_FOLDER."product");?>">商品列表</a> &gt; <a href="<?php echo site_url(CTL_FOLDER."product_catalog");?>">分类列表</a> &gt; 分类修改</td>
  </tr>
</table>
<fieldset>
<legend>分类修改</legend>
<form action="<?php echo site_url(CTL_FOLDER."product_catalog/save_record");?>" method="post" name="dialog_edit_form" id="dialog_edit_form" onsubmit="return Validator.Validate(this,3)">
  <table width="100%"  border="0" cellpadding="3" cellspacing="0" >
    ...
    <tr>
      ...
      <td><input name="rd_id" type="hidden" value="<?php echo $edit_data['id'];?>" />
        ...
        <input type="submit" name="sbmit" value="修改" class="button-style2" /></td>
    </tr>
  </table>
</form>
</fieldset>
