...
<table width="100%" border="0" cellpadding="5" cellspacing="0" >
  <tr>
    ...
    <td width="97%" align="left" >您现在的位置：<a href="<?php echo site_url(CTL_FOLDER."rule");?>">采集规则列表</a> &gt; 添加采集规则 </td>
  </tr>
</table>
<fieldset>
<legend>添加采集规则</legend>
  <form action="<?php echo site_url(CTL_FOLDER."rule/add_record");?>" method="post" name="dialog_add_form" id="dialog_add_form">
    ...
    <tr>
      ...
      <td width="561"><input name="charset" type="text" size="10" dataType="Require" msg="该项必须填写" maxlength="20" />
    ...
    <tr>
      ...
      <td width="561"><input name="page_total" type="text" size="5" dataType="Int" msg="格式有误" maxlength="8" /></td>
    </tr>
    <tr>
      <td width="152"><font color="#FF0000">*</font>分页步长：</td>
      <td width="561"><input name="page_step" type="text" size="5" value="1" dataType="Int" msg="格式有误" maxlength="8" />
        一般填写 1 即可，步长 = 相邻两个页数之差。</td>
    </tr>
    <tr>
      <td width="152"><font color="#FF0000">*</font>列表区开始标记：</td>
      <td width="561"><textarea dataType="Limit" max="500" min="1" msg="长度1-500" name="list_block_s" cols="50" rows="5"></textarea>
        <br>
        简短，达到唯一性即可，不包含列表项在内，一般为包围列表项的开始标签。</td>
    </tr>
    <tr>
      <td width="152"><font color="#FF0000">*</font>列表区结束标记：</td>
      <td width="561"><textarea dataType="Limit" max="500" min="1" msg="长度1-500" name="list_block_e" cols="50" rows="5"></textarea>
        <br>
    ...
    <tr>
      ...
      <td width="561"><textarea dataType="Limit" max="500" min="1" msg="长度1-500" name="list_link_s" cols="50" rows="5"></textarea>
        <br>
    ...
    <tr>
      ...
      <td width="561"><textarea dataType="Limit" max="500" min="1" msg="长度1-500" name="list_link_e" cols="50" rows="5"></textarea>
        <br>
    ...
    <tr>
      ...
      <td width="561"><textarea dataType="Limit" max="500" min="1" msg="长度1-500" name="detail_s" cols="50" rows="5"></textarea>
        <br>
        简短，达到唯一性即可，不包含正文部分，一般为包围正文的开始标记。</td>
    </tr>
    <tr>
      <td width="152"><font color="#FF0000">*</font>详细页面正文结束标记：</td>
      <td width="561"><textarea dataType="Limit" max="500" min="1" msg="长度1-500" name="detail_e" cols="50" rows="5"></textarea>
        <br>
