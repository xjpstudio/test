...
<fieldset>
  ...
  <form action="<?php echo site_url(CTL_FOLDER."shop/save_shop_add");?>" method="post" enctype="multipart/form-data">
   ...
   <tr>
        ...
        <td><input name="shop_url" value="<?php echo $shop['shop_url'];?>" id="shop_url" type="text" size="80" datatype="Require" msg="该项必须填写" />  &nbsp; <input type="button" onclick="get_data()" value="获取数据" class="button-style" /> <br />例如：http://yy2001.taobao.com</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td><input type="text" name="keyword" maxlength="100" size="80" value="<?php echo $shop['title'];?>" />
          <br>
          一般不超过100个字符</td>
      </tr>
      <tr>
        <td valign="top">meta描述：</td>
        <td><textarea name="description" cols="80" rows="3" dataType="Limit" max="200" msg="字数不超过200" require="false"><?php echo $shop['title'];?></textarea>
          <br>
          一般不超过200个字符</td>
      </tr>
      <tr>
