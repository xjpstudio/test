...
class Link extends Controller
{
	...
	function index()
	{
		...
		$sql = 'SELECT * FROM '.$this->db->dbprefix.'shop_link WHERE 1=1';
	...
	{
		$link = $this->common_model->get_records('SELECT title,hplink FROM '.$this->db->dbprefix.'shop_link ORDER BY seqorder DESC,id DESC');
