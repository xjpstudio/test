    ...
    <form action="install_save.php" method="post">
      ...
      <table border="0" cellpadding="5" cellspacing="0">
        ...
        <tr>
          ...
          <td align="left"><input type="text" name="dbprefix" class="ui-tx-input"  value="sh_" dataType="Custom" regexp="^\w+$" maxlength="10" msg="格式有误，只能是字母数字或下划线"  title="建议修改，字母开头然后跟个下划线"  style="width:150px"  />
          </td>
        </tr>
      </table>
      <div class="clear"></div>
      ...
      <table width="100%" border="0" cellpadding="5" cellspacing="0">
        ...
        <tr>
          <td align="left"><font style="color:#FF0000">*</font>管理员邮箱：</td>
          <td align="left"><input type="text" name="admin_email"  value="" id="admin_email" dataType="Email" msg="邮箱格式有误" class="ui-tx-input" maxlength="100" title="很重要，作为找回密码的接收邮箱，必须有效"  style="width:150px" /></td>
        </tr>
      </table>
      <div class="clear"></div>
      </fieldset>
