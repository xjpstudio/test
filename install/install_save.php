...
if( ! isset($admin_email) || empty($admin_email)) $error_msg.="管理员邮箱不能为空<br>";
...
//添加管理员
mysql_query("DELETE FROM {$dbprefix}shop_admin", $connect);
$sql="INSERT INTO `{$dbprefix}shop_admin` (`user_name`,`password`,`email`,`user_role`,`user_limit`,`hits`,`create_date`) VALUES ('".$admin_name."','".md5($admin_password)."','".$admin_email."',1,'0',0,".time().")";
