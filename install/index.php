...
<div id="ui-tx-main">
  ...
  <div class="ui-tx-right">
    ...
    <table width="100%" border="0" cellpadding="5" cellspacing="0">
      <tr>
        <td><?php 
	$list = array('backup','cache','app/config','uploadfiles','uploadfiles/files','uploadfiles/images','uploadfiles/pack','uploadfiles/unpack');
...
?>
          ...
          <?php 
			...
			{
				echo "<span style='color:#006600'>目录可写</span> <br />";
			}
			else
			{
				echo "<span style='color:#FF0000'>目录不可写</span> <br />";
			}
	}
?></td>
      </tr>
